...
import 'package:contentbuddyromesh/screens/EditUser.dart';
import 'package:contentbuddyromesh/screens/addUser.dart';
import 'package:contentbuddyromesh/screens/viewUser.dart';
  ...
  getAllUserDetails() async {
    ...
    users.forEach((user) {
      setState(() {
        ...
        userModel.tel = user['email'];
        userModel.email = user['description'];
          ...
          itemBuilder: (context, index) {
            return Card(
              child: ListTile(
                ...
                subtitle: Text(_userList[index].tel ?? ''),
                trailing: Row(
